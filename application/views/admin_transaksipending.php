                  ...
                  <?php foreach($transaksi['returned'] as $item):?>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <form action="<?= base_url('Cart/userupdatetrans/cancel_retur/'.$row->id)?>" method="post">
                              <input type='submit' class='btn btn-primary mt-2' id='<?=$row->id?>_submit' value='Tolak Pengajuan'>
                            </form>
                      </td>
                    </tr>
                  <?php endforeach;?>
