	 	...
	 	var id='';
	 		...
	 		$(".shipping_radio").change(function() {
	 			...
	 			if(radio_id=="radio_1"){
	 				...
	 				harga_antar = 0;
	 				$(".cart_extra_total_value_shipping").html("Gratis");
	 			}
	 			var Subtotal = $(".cart_extra_total_value").attr("harga");
	 			var diskon = $(".cart_extra_total_value_diskon").attr("harga");
	 			var grandtotal = parseInt(Subtotal)+parseInt(harga_antar)-parseInt(diskon);
							...
							<table class="cart" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>L</td>
										<td>Rp.<?php echo number_format($items->harga,2,",",".");?></td>
										<td><div class="product_quantity ml-lg-auto mr-lg-auto text-center">
											<span class="product_text product_num" id="jml_brg"><?php echo $items->jumlah;?></span>
											<div class="qty_sub qty_button trans_200 text-center"id="<?php echo $items->id;?>"><span>-</span></div>
											<div class="qty_add qty_button trans_200 text-center" id="<?php echo $items->id;?>"><span>+</span></div>
										</div></td>
										<td>Rp.<?php echo (number_format($items->harga*$items->jumlah,2,",","."));?>.00</td>
										<?php
											echo "<td class='cart_delete'>";
											echo "<input type='button' value='X' name='delete' id='".$items->id."' class='btn btn-fefault cart'>";
											echo "</td>";
										?>
									</tr>
									<?php
							...
							<div class="cart_extra_content cart_extra_total">
								...
								<ul class="cart_extra_total_list">
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value ml-auto" harga="<?php echo $total[0]->total;?>"><?php
										foreach($total as $row)
										{
											echo "<span>Rp ".number_format($row->total,2,",",".")."</span>";
										}
										?></div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div class="cart_extra_total_title">Diskon</div>
										<?php
										$tmp = $total[0]->total;
											if(isset($persen)){
												$new=intval($tmp);
												$persendiskon = intval($persen);
											...
											if(isset($potong)){
												...
												$val = intval($potong);
												$total = $new-$val;
												$promo = "Rp. ".number_format($val,2,",",".");
												$this->session->set_userdata('total',$total);
											}
										?>
										<!--yang dicari-->
										<div class="cart_extra_total_value_diskon ml-auto" harga="<?php echo $val;?>"><?php echo $promo;?>
										</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value_gt ml-auto"><?php
											echo "<span>Rp ".number_format($total,2,",",".")."</span>";
										?></div>
									</li>
								</ul>
