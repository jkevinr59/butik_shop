			  ...
			  <?php
                ...
                <div class="row">
	                <div class="container">
	                	...
	                	<ul class="navbar_menu">
	                		<li><a href="#" class="actived" style="border-style: solid;">Jualan</a></li>
	                    ...
	                    <?php
	                        ...
	                        echo form_open_multipart('Cont/tambah_barang')."<br>";
	                        echo form_hidden('id_toko', $toko->id_toko)."<br>";
	                        echo form_input('nama', '', "placeholder='Nama Barang'  class='form-control'")."<br>";
	                        echo form_input('harga', '', "placeholder='Harga Barang'  class='form-control'")."<br>";
	                        echo form_input('stok', '', "placeholder='Stok Barang'  class='form-control'")."<br>";
	                        echo form_textarea('deskripsi', '', "placeholder='Deskripsi'  class='form-control'")."<br>";
	                        ...
	                        <?php
	                        echo form_label('Foto Barang','',"class='form-control-label'")."<br>";
	                        echo form_upload('foto','',"class='form-control'")."<br>";
	                        echo form_label('Foto Detail(Optional)','',"class='form-control-label'")."<br>";
	                        ?>
	                        <input type='file' name='files[]' class="form-control" multiple ><br><input type="hidden" id="hiddenblog"name="blog" value="0">
	                        <button id="tampilkan_blog" type="button" class="button-login">Ingin Buat Blog</button><br>
	                        <div id="desain_blog">
	                        <?php
	                        echo form_label('Foto Blog','',"class='form-control-label'")."<br>";
	                        echo form_upload('foto_blog','',"class='form-control'")."<br>";
	                        ?>
	          					<textarea id="textarea" name="isiblog"></textarea><br>
          					<?php
	                        echo form_label('Foto list Blog','',"class='form-control-label'")."<br>";?>
	                        	<input type='file' name='files_blog[]' class="form-control" multiple >
	                        </div>
	                        <br>
	                        <?php
	                        echo form_submit('tambah', 'Tambah',"class='button-login'")."<br>";
	                        echo form_close();
	                }
