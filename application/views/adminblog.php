...
<div class="main">
  <div class="hipsum">
    <div class="jumbotron">
      ...
      <?php
        if(!isset($id)){
            echo form_open_multipart('Admin/addblog')."<br>";
            echo form_label('Judul Blog')."<br>";
            echo form_input('id')."<br><br>";
            ...
            <br>
            <?php
            echo form_submit('tambah', 'Add',"class='button-login'")."<br>";
            echo form_close(); 
        }
        else{
            echo form_open_multipart('Admin/update_Blog')."<br>";
            echo form_label('Judul Blog')."<br>";
            echo form_input('id_baru',$id)."<br><br>";
            echo form_label('Foto Blog','',"class='form-control-label'")."<br>";
            echo form_upload('foto_blog','',"class='form-control'")."<br>";
            echo form_hidden('id', $id);
            // echo form_hidden('nama', $nama);
            ?>
              <textarea id="textarea" name="isiblog"><?php echo $blog->isi;?></textarea><br>
            <?php
            echo form_label('Foto list Blog','',"class='form-control-label'")."<br>";
            ?>
              <input type='file' name='files_blog[]' class="form-control" multiple >
