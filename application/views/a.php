...
<div class="main">
  <div class="hipsum">
    ...
    ?>
      ...
      <label for="namabrg">Nama Admin:</label>
      <input type="text" class="form-control" id="namaadmin" name="namaadmin" value=<?php echo $admin->user_admin;?>>
      </div><br>
      <div class="form-group">
      <label for="namabrg">Password Lama:</label>
      <input type="text" class="form-control" id="passlama" name="passlama">
      </div><br>
      <div class="form-group">
      <label for="namabrg">Password Baru:</label>
      <input type="text" class="form-control" id="passbaru" name="passbaru">
      </div><br>
      <div class="form-group">
      <label for="namabrg">Konfirmasi Password Baru:</label>
      <input type="text" class="form-control" id="conpass" name="conpass">
      </div><br>
       <?php 
       echo form_submit('name', 'Update');
       echo form_close(); ?>
  </div>
</div>
