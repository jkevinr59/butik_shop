	...
	<div class="main_slider">
                ...
                <div class="container">
                    ...
                    <?php
                                ...
                                echo form_open_multipart('Cont/updateprofile');
                                ?>
                                <div type="file" class="form-group container-foto" >
							<img src="
							<?php
								if($data->foto_user!="" && $data->foto_user!=null){
									echo base_url('fotouser/'.$data->foto_user);
								}
								else{
							?>
							...
							<?php
								echo form_upload('foto_user','',"id='imgInp' class='overlay'");
							?>
							<!-- <input type="file" name="foto_toko" id="imgInp" class="overlay"> -->
						  </div>
                                <?php
                                echo form_input("nama",$data->Nama_user,"placeholder='Nama User'  class='form-control'")."<br>";
                                echo form_password("password","","placeholder='Password'  class='form-control'")."<br>";
                                echo form_password("confirm","","placeholder='Confirm Password'  class='form-control'")."<br>";
                                echo form_input("alamat",$data->Alamat,"placeholder='Alamat'  class='form-control'")."<br>";
                                echo form_input("notelp",$data->NoTelp,"placeholder='Nomor Telp'  class='form-control'")."<br>";
                                echo form_submit("update","Update Profile","class='button-login'")."<br>";
                                echo form_close()."<br>";
