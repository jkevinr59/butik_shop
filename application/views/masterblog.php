      ...
      <table class="table table-bordered">
            <tr>
              ...
              <?php
                ...
                {
                  if($row->barang_nama==null){
                    echo "<tr>";
                    echo "<td><img src='".base_url('ikonblog/').$row->foto_blog."' width=200px>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp $row->id_barang</td>";
                    echo "<td>";
                    echo form_open('Admin/updateblog');
                    echo form_hidden('id', $row->id_barang);
                    echo form_submit('update', 'Update');
                    echo form_close();

                    echo form_open('Admin/deleteblog');
                    echo form_hidden('id', $row->id_barang);
                    echo form_submit('update', 'Delete');
                    echo form_close();
                    echo "</td>";
                    echo "</tr>"; 
                  }
